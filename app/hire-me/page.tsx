  ...
  return (
    <MaxWidthWrapper className="mx-auto mt-16">
      ...
      <p className="text-center mt-10 text-lg">
        ...
        create and design, present and deliver, and to cater to your needs.
      </p>
      <p className="text-center mt-10 text-lg">
        Design is not just my passion, it’s a big part of my lifestyle. Yeah, I
        know it’s a cliché. Here, fill out the questionnaire below or read
      ...
      <p className="text-sm dark:text-gray-400 text-gray-700">
        ...
        due to the confidential nature of the projects I can’t showcase them all
        in public.
      </p>
      <p className="mb-10 mt-16 text-5xl ">Questionnaire</p>
      <p className="mb-5">
        Requesting an estimate for a project only takes a few minutes of your
        time and costs absolutely nothing. This questionnaire was built to help
        me identify your needs for the project.
      </p>
      <Form {...form}>
